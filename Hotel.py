   ...
   if c[2] >= 2019 and c[2] <= 2023:
      ...
      if c[1] != 0 and c[1] <= 12:
         ...
         if c[1] == 2 and c[0] != 0 and c[0] <= 31:
            ...
            # if month is odd and less than equal
            # to 7th month
         elif c[1] <= 7 and c[1]%2 != 0 and c[0] <= 31:
              pass
      
            # if month is even and less than equal to 7th
            # month and not 2nd month
         elif c[1] <= 7 and c[1]%2 == 0 and c[0] <= 30 and c[1] != 2:
              pass
      
            # if month is even and greater than equal 
            # to 8th month
         elif c[1] >= 8 and c[1]%2 == 0 and c[0] <= 31:
              pass
      
            # if month is odd and greater than equal
            # to 8th month
...
# use global keyword 'i'
    ...
    # if-conditions to display alloted rooms
    # type and its price
    if ch==0:
    ...
    # checks if alloted room no. and customer
...
def Rooms_Info():
   ...
   print("3-Bed NON-AC")
   print("****************************************")
   print("Room amenities include: 1 Double Bed + 1 Single Bed, Television, Telephone,")
...
def restuarant():
   ...
   for n in range(0,i):
      if custid[n]==ph and p[n]==0:
         ...
         print("3 Coffee..........30.00    ROTI")
         print("4 Cold Drink..........30.00    ************************")
         ...
         print("8 Veg. Toast Sandwich......50.00    32 Butter Naan..........30.00")
         print("9 Cheese Toast Sandwich..........70.00    ")
         print("10 Grilled Sandwich..........70.00     RICE")
         print("                           ************************")
         print(" SOUPS                        33 Plain Rice..........90.00")
         print("*******************          34 Jeera Rice...........90.00")
         print("11 Tomato Soup..........100.00    35 Veg Pulao..........100.00")
         print("12 Hot N Sour.........110.00    36 Peas Pulao..........100.00")
         print("13 Veg. Noodle Soup......120.00")
         print("14 Sweet Corn..........120.00     SOUTH INDIAN")
         print("15 Veg. Munchow..........120.00    *********************")
         print("")
         print(" MAIN COURSE                   38 Onion Dosa..........70.00")
         print("*******************            39 Masala Dosa...........80.00")
         print("16 Shahi Paneer...........110.00    40 Paneer Dosa..........90.00")
         print("17 Kadai Paneer..........110.00    41 Idli Sambhar..........100.00")
         print("18 Handi Paneer.........120.00    42 Vada Sambhar..........100.00")
         ...
         print("25 Aloo Matar...........140.00    46 Butterscotch..........60.00")
         ...
         while(ch!=0):
            ...
            # if-elif-conditions to assign them
         ...
         # updates restuarant charges and then
         # appends in 'rc' list
         r=r+rc.pop(n)
         rc.append(r)
      else:
